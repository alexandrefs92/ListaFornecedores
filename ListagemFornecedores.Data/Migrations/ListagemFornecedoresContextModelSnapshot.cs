...
namespace ListagemFornecedores.Data.Migrations
{
    ...
    partial class ListagemFornecedoresContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("ListagemFornecedores.Domain.Entities.Fornecedor", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CPFCNPJ = "47.687.465/0001-26", DataCadastro = new DateTime(2019, 10, 29, 22, 39, 14, 147, DateTimeKind.Local), DataNascimento = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), EmpresaId = 1, Nome = "Fornecedor PJ 1" },
                        new { Id = 2, CPFCNPJ = "002.743.400-11", DataCadastro = new DateTime(2019, 10, 29, 22, 39, 14, 149, DateTimeKind.Local), DataNascimento = new DateTime(1992, 5, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), EmpresaId = 1, Nome = "Fornecedor PF 1", RG = "42.039.268-3" },
                        new { Id = 3, CPFCNPJ = "959.444.850-43", DataCadastro = new DateTime(2019, 10, 29, 22, 39, 14, 149, DateTimeKind.Local), DataNascimento = new DateTime(1992, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), EmpresaId = 2, Nome = "Fornecedor PF 2", RG = "25.376.771-4" }
                    );
                });
